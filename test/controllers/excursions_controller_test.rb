...
class ExcursionsControllerTest < ActionController::TestCase
  ...
  test "should create excursion" do
    assert_difference('Excursion.count') do
      post :create, excursion: { city_id: @excursion.city_id, descr: @excursion.descr, name: @excursion.name, price: @excursion.price }
    end
  ...
  test "should update excursion" do
    patch :update, id: @excursion, excursion: { city_id: @excursion.city_id, descr: @excursion.descr, name: @excursion.name, price: @excursion.price }
    assert_redirected_to excursion_path(assigns(:excursion))
  end
