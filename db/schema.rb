...
ActiveRecord::Schema.define(version: 20170422145448) do
  ...
  add_index "excursions", ["name"], name: "index_excursions_on_name", unique: true, using: :btree
  ...
  add_index "routes", ["name"], name: "index_routes_on_name", unique: true, using: :btree
